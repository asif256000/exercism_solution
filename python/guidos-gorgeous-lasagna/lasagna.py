...
def preparation_time_in_minutes(num_of_layers):
    """
    Return preparation time for the number of layers.

    This function takes the number of layers and returns total preparation time based
    on number of layers and preparation time per layer.
    """
